               ...
               imagepara={[
                  {
                     heading: 'PICK-UP',
                     para:
                        'Set Pickup Time Range Daily, Weekly, Monthly, etc.Ensure Contactless Pickup'
                  },
                  {
                     heading: 'DELIVERY',
                     para:
                        'Opt for Self-Delivery or Partner with a 3rd-Party Set Multiple Delivery Choices Based on: Day, Delivery Range, Cost, etc..'
                  }
               ]}
               image1url={
